...
/**
 * Test for /workHistory
 */
Test('/workHistory', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test workHistory_get get operation', function (t) {
            Mockgen().requests({
                path: '/workHistory',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/workHistory']['get']['responses']['200']['schema']);
